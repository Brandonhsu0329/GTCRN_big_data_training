...
if __name__ == "__main__":
    ...
    # ========== 配置參數 ==========
    flag = 'train'  # 仍使用 train CSV，但輸出到 val_data
    num_tot = 1920
    ...
    # ========== 讀取文件列表 ==========
    print("=" * 60)
    print("Loading file lists for VALIDATION data...")
    print("=" * 60)
    ...
    # ========== 生成驗證數據 ==========
    print("\n" + "=" * 60)
    print(f"Generating {num_tot} VALIDATION samples (without reverberation)...")
    print("=" * 60)
