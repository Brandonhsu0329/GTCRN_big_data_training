...
import sys
sys.path.insert(0, '/home/sbplab/yuchen/GTCRN/SEtrain')
...
CONFIG = {
    'model_path': '/home/sbplab/yuchen/GTCRN/SEtrain/experiments/gtcrn_weaker_student_2025-12-15-01h27m/checkpoints/model_150.tar',
    'model_config': '/home/sbplab/yuchen/GTCRN/SEtrain/experiments/gtcrn_weaker_student_2025-12-15-01h27m/config.yaml',
    'sample_rate': 16000,
    'output_dir': '/home/sbplab/yuchen/GTCRN/SEtrain/experiments/gtcrn_weaker_student_2025-12-15-01h27m/evaluation_results',
...
def load_audio(audio_path, target_sr=16000):
    """載入並預處理音頻 - 使用soundfile避免torchaudio版本問題"""
    # 使用soundfile讀取
        ...
        for noise_name in speaker_config['noises']:
            ...
            for snr in config['snr_levels']:
                ...
                if file_idx in save_indices:
                    ...
                    # 使用soundfile保存,避免torchaudio版本問題
                    sf.write(audio_dir / "clean.wav", clean_trim.numpy(), 16000)
                    sf.write(audio_dir / "noisy_input.wav", noisy_trim.numpy(), 16000)
                    sf.write(audio_dir / "denoised_output.wav", denoised_trim.numpy(), 16000)
